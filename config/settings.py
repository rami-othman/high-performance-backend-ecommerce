...
CHECKOUT_CAPACITY_TEST_LIMIT_OVERRIDE_ENABLED = env_bool(
    "CHECKOUT_CAPACITY_TEST_LIMIT_OVERRIDE_ENABLED",
    DEBUG,
)
CHECKOUT_CAPACITY_TEST_LIMIT_MAX = env_int("CHECKOUT_CAPACITY_TEST_LIMIT_MAX", 1000, min_value=1)
